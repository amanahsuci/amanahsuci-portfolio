                            ...
                            >
                                ...
                                <div className="flex flex-col gap-3 p-5 flex-1">
                                    ...
                                    <div className="flex gap-3 pt-2 border-t border-white/[0.06] mt-auto">
                                        {project.githubUrl && (
                                            <span className="inline-flex items-center gap-1.5 text-xs text-white/40 font-[family-name:var(--font-dm)]">
                                        ...
                                        {project.liveUrl && (
                                            <span className="inline-flex items-center gap-1.5 text-xs text-[#c9a84c]/70 font-[family-name:var(--font-dm)]">
